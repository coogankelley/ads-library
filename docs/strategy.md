...
Before anyone writes a hook or films a thing, the whole team needs to know the strategy. Not "make some ads and see what happens." We run a deliberate test program: **one variable at a time, built off one script.** That is the entire game. Everything in this library serves it.
