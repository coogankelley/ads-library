...
The test is simple. Standalone "you" is fine. "You + an attribute" is not.

- "Imagine a day that is yours." Fine. That is future-pace, no attribute claimed.
- "You're exhausted from another double shift." Flagged. You just claimed to know her job and her physical state.
- "The thing keeping you stuck in scrubs." Flagged. Same problem, dressed up.
- "You already tried the promotion and it did not fix it." Flagged. You claimed to know her history.
...
- **First person.** You describing your own story is always allowed. "I was sitting in my car after shifts, completely empty." That is your attribute, not hers.
- **Third person / general situation.** "A lot of nurses hit a wall around year ten." A general truth, not a call-out of the viewer.
- **Future pace.** "Imagine booking a flight on a random Tuesday." Painting the life, not diagnosing her current one.
...
**AI tells:** unlock, unleash, embark, delve.

**Coach / spiritual-bypass:** queen, babe, sister, goddess, manifest, tap in, high-vibe, abundance.

**Income-claim language:** 6-figure, 7-figure, financial freedom, laptop lifestyle.

**Marketing clichés:** game-changer, next level, level up, 10x (or any "10x" framing).

**Industry red flags:** recession-proof, economy-proof, AI-proof, boss babe, quit your 9-to-5, fire your boss, escape the rat race.
...
Before any ad ships, it passes this sweep:

1. No personal-attribute call-outs (no "you + her job / money / feelings").
2. No income claims, no dollar figures on earnings.
3. No fake scarcity or urgency.
4. No banned words.
5. No em dashes.
6. Company unnamed.
...
- Ready to write with the guardrails in place? [Writing the body](writing-the-body.md) and [Hooks](hooks.md).
- Want the full picture of where the ad sits: [Foundations](foundations.md).
